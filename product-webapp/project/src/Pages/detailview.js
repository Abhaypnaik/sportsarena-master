...
const listSubmit = () => {
//     return fetch("http://3.18.53.7:8080/createdslots", {
//         headers: {
...
//     })
return axios.get(`http://3.18.53.7:8080/booking-Management/api/v1/slotslist/groundID/`+location.state.groundID)
 .then((res)=>{
...
const getdetailview = () => {
  console.log("id");
    axios.get(`http://3.18.53.7:8080/user/api/v1/ground/groundID/`+location.state.groundID)
    .then((res)=>{
...
// const slotAdd = (slotId) => {
  ...
  // axios
  //   .post(`http://3.18.53.7:8080/booking-Management/api/v1/newbooking`,)
const slotAdd = (slotDetail) => {
   console.log(slotDetail);
  setSelectedSlot(slotDetail);
  
  /*axios
    .post(`http://3.18.53.7:3000/booking`)
    .then((res) => {
